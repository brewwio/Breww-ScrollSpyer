var AnimateCss = (function () {
    ...
    ***************************************************************************** */
    ...
    var AnimateCss = /** @class */ (function () {
        ...
        AnimateCss.initAnimation = function (section, animationOptions) {
        ...
        AnimateCss.prototype.Bewwopacity = function (sections, animateDistance) {
        ...
        AnimateCss.prototype.animateTwoWay = function (section, sections, animationOptions) {
        ...
        AnimateCss.prototype.animateOneWay = function (section, animationOptions) {
            if (!animationOptions.enabled)
                return false;
            if (!(section instanceof HTMLElement)) {
                throw new Error("First argument must be of type HTMLElement");
