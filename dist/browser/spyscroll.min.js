var SpyScroll = (function () {
  ...
  var SpyScroller = /** @class */ (function () {
      ...
      SpyScroller.prototype.easeInOutQuad = function (t) {
          ...
          if (this.options.targetSelector === "[data-jump]") {
              ...
              items.forEach(function (item) {
                  item.addEventListener("click", function (event) {
                      ...
                      var refId = item.getAttribute("data-jump");
                      console.log(document.getElementById(refId));
                      _this.scrollTo(document.getElementById(refId), 1000, _this.easeInOutQuad);
                  });
              });
          }
      };
