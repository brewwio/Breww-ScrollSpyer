  ...
  var SpyScroller = /** @class */ (function () {
      ...
      SpyScroller.prototype.getActiveMenuItem = function (section) {
          ...
          if (this.options.targetSelector === "[data-jump]") {
              ...
              var element = this.menuList.querySelector("[href=\"#".concat(sectionId, "\"]"));
              return {
                  sectionId: sectionId,
                  element: element
              };
      ...
      SpyScroller.prototype.onScroll = function () {
          ...
          var activateSectionId = activeMenuItem.sectionId;
      ...
      SpyScroller.prototype.executeLastSectionCallbackIfInView = function (activateSectionId, menuItem) {
